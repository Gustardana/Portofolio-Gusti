            ...
            <div className="pt-4 flex items-center justify-between">
              ...
              {id ? (
                <Link
                  ...
                  className="inline-flex items-center space-x-2 px-4 py-2 rounded-lg bg-[#030014]/5 hover:bg-[#030014]/10 text-white/90 transition-all duration-200 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                >
