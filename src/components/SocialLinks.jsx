...
// import PresenceWidget from "./PresenceWidget"; // Pastikan file ini ada jika tidak di-comment
...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/gustardana/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@gustardana",
    icon: Instagram,
    url: "https://www.instagram.com/gustardana/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@gustardana",
    icon: Youtube,
    url: "https://www.youtube.com/@gustardana",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@gustardana",
    icon: Github,
    url: "https://github.com/gustardana",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@gustardana",
    color: "black",
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-lg 
                     bg-[#030014]/5 border border-white/10 overflow-hidden
