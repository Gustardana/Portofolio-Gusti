...
const SkeletonCard = () => (
  <div className="relative">
    ...
    <div className="relative bg-[#030014]/5 border border-white/12 rounded-2xl p-4 flex flex-col gap-3">
      <div className="w-full aspect-[16/8] bg-[#030014]/5 animate-pulse rounded-xl" />
      <div className="h-4 bg-[#030014]/5 animate-pulse rounded-lg w-2/3" />
      <div className="h-3 bg-[#030014]/5 animate-pulse rounded-lg w-full" />
      <div className="h-3 bg-[#030014]/5 animate-pulse rounded-lg w-4/5" />
      <div className="flex gap-1.5 mt-1">
        <div className="h-5 w-16 bg-[#030014]/5 animate-pulse rounded-full" />
        <div className="h-5 w-12 bg-[#030014]/5 animate-pulse rounded-full" />
        <div className="h-5 w-20 bg-[#030014]/5 animate-pulse rounded-full" />
      </div>
      <div className="flex justify-between items-center pt-2 border-t border-white/8 mt-auto">
        <div className="flex gap-2">
          <div className="w-7 h-7 bg-[#030014]/5 animate-pulse rounded-lg" />
          <div className="w-7 h-7 bg-[#030014]/5 animate-pulse rounded-lg" />
        </div>
        <div className="flex gap-2">
          <div className="w-14 h-7 bg-[#030014]/5 animate-pulse rounded-lg" />
          <div className="w-16 h-7 bg-[#030014]/5 animate-pulse rounded-lg" />
        </div>
      </div>
    </div>
  </div>
  ...
  return (
    <Card>
      <div className="p-4 flex flex-col h-full">
        {project.Img && (
          <div className="w-full aspect-[16/8] rounded-xl mb-4 border border-white/8 overflow-hidden bg-[#030014]/5">
            {!imgLoaded && (
              <div className="w-full h-full animate-pulse bg-[#030014]/5" />
            )}
            <img
              src={project.Img}
              alt={project.Title}
        ...
        {project.TechStack?.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mb-3">
            {project.TechStack.map((t) => (
              <span
                key={t}
                className="px-2 py-0.5 rounded-full bg-blue-500/15 border border-blue-500/25 text-indigo-300 text-xs"
              >
                {t}
              </span>
            ))}
        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-2 border-t border-white/8">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-blue-500/25 text-indigo-400 hover:bg-blue-500/10 text-xs transition-colors"
            >
...
const Modal = ({ title, onClose, children }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
    ...
    >
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#4FACFE] to-[#00F2FE] rounded-2xl blur opacity-20 pointer-events-none" />
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <label className="flex items-center gap-4 w-full bg-[#0d0d22] border border-dashed border-white/15 rounded-xl px-4 py-4 cursor-pointer hover:border-blue-500/40 hover:bg-[#030014]/4 transition-all">
            {preview ? (
              <img
                src={preview}
              ...
              <div className="w-24 h-16 rounded-lg bg-[#030014]/5 flex items-center justify-center border border-white/10">
