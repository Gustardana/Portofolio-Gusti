    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#4FACFE] to-[#00F2FE] rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-700" />
          <div className="relative bg-[#030014]/5 backdrop-blur-xl border border-white/15 rounded-2xl p-8 space-y-7">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="flex items-center bg-[#030014]/8 border border-white/15 rounded-xl overflow-hidden focus-within:border-blue-500/60 transition-colors">
