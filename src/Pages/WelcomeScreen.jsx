            ...
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  ...
                  <div>
                    <span data-aos="fade-up" data-aos-delay="800" className="inline-block px-2 bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
                      Portfolio
                    </span>{' '}
                    <span data-aos="fade-up" data-aos-delay="1000" className="inline-block px-2 bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
                      Website
                    </span>
                  </div>
                </h1>
              ...
              >
                <a
                  href="https://gustardana.com"
                  className="inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full relative group hover:scale-105 transition-transform duration-300"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#4FACFE]/20 to-[#00F2FE]/20 rounded-full blur-md group-hover:blur-lg transition-all duration-300" />
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    {/* Warna ikon Globe disesuaikan ke warna Cyan terang */}
                    <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-[#00F2FE]" />

                    {/* Warna teks efek mesin tik diubah ke Cyber-Blue */}
                    <span className="bg-gradient-to-r from-[#4FACFE] to-[#00F2FE] bg-clip-text text-transparent">
                      <TypewriterEffect text="gustardana.com" />
                    </span>
                  </div>
                </a>
              </motion.div>
