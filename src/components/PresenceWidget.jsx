  ...
  const getColors = (type) => {
    const colors = {
      ...
      default: {
        ...
        border: "border-blue-500/30",
        text: "text-cyan-400",
        badge: "bg-blue-500/20 border-cyan-400/40",
        glow: "shadow-blue-500/20"
      }
    };
                    ...
                    {act.type === "spotify" && (
                      <div className="absolute -bottom-0.5 -right-0.5 bg-green-500 rounded p-0.5 shadow-lg">
                        <div className="flex items-end gap-0.5 h-2">
                          <div className="w-0.5 bg-[#030014] rounded-full animate-music-1"></div>
                          <div className="w-0.5 bg-[#030014] rounded-full animate-music-2"></div>
                          <div className="w-0.5 bg-[#030014] rounded-full animate-music-3"></div>
                        </div>
                      </div>
                    )}
                  </div>
