    ...
    <div 
        className={`px-4 pt-4 pb-2 rounded-xl border transition-all group hover:shadow-lg hover:-translate-y-0.5 ${
            isPinned 
                ...
                : 'bg-[#030014]/5 border-white/10 hover:bg-[#030014]/10'
        }`}
    >
        {isPinned && (
        ...
        <div className="flex items-start gap-3">
            {comment.profile_image ? (
                ...
                <div className={`p-2 rounded-full text-indigo-400 group-hover:bg-blue-500/30 transition-colors ${
            ...
            <div className="flex-grow min-w-0">
                <div className="flex items-center justify-between gap-4 mb-2">
                    <div className="flex items-center gap-2">
                        ...
                        {isPinned && (
                            <span className="px-2 py-0.5 text-xs bg-blue-500/20 text-indigo-300 rounded-full">
                                Admin
                            </span>
                        )}
                    </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-[#030014]/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-[#030014]/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                ...
                <div className="flex items-center gap-4 p-4 bg-[#030014]/5 border border-white/10 rounded-xl">
                    {imagePreview ? (
                        ...
                        <div className="w-full">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-500/20 text-indigo-400 hover:bg-blue-500/30 transition-all border border-dashed border-blue-500/50 hover:border-blue-500 group"
                            >
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#4FACFE] to-[#00F2FE] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
                <div className="absolute inset-0 bg-[#030014]/20 translate-y-12 group-hover:translate-y-0 transition-transform duration-300" />
